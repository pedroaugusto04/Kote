...
function deriveTimelineCategory(source: string | undefined): string {
  ...
  if (s === SOURCE_VALUES.GITHUB_PUSH || s === SOURCE_VALUES.GITHUB) return SOURCE_VALUES.GITHUB_PUSH;
  if (s === SOURCE_VALUES.WHATSAPP || s === SOURCE_VALUES.WHATSAPP_CHANNEL) return SOURCE_VALUES.WHATSAPP_CHANNEL;
  if (s === SOURCE_VALUES.AI_CHAT) return SOURCE_VALUES.AI_CHAT;
