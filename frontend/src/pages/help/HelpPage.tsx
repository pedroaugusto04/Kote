...
type SectionId = 'overview' | 'projects' | 'ai-chat' | 'messaging-integrations' | 'github-integration' | 'ai-integrations' | 'webhooks' | 'push-notifications' | 'cli' | 'vscode' | 'dependency-watcher' | 'mcp' | 'reminders' | 'map';
...
Body:
{
  ...
  },
  {
    ...
    description: 'Automatically monitor package dependencies across multiple ecosystems and get notified about security updates and breaking changes.',
    items: [
      {
        title: 'Multi-Ecosystem Support',
        body: 'Detects dependencies from package.json (npm), requirements.txt (pip), composer.json (composer), pom.xml (maven), and Cargo.toml (cargo).',
      },
      {
        title: 'GitHub Integration',
        body: 'Connect GitHub repositories to automatically import dependencies from your codebase.',
        steps: [
          'Go to Settings → Integrations → Dependency Watcher',
          'Connect the GitHub App',
          'Select repositories to monitor',
          'Import dependencies from selected repositories',
        ],
      },
      {
        title: 'AI-Powered Analysis',
        body: 'The system analyzes changelogs to classify update urgency as critical, recommended, or optional.',
      },
      {
        title: 'Email Alerts',
        body: 'Receive email notifications for critical and recommended updates with detailed analysis.',
      },
      {
        title: 'Knowledge Base Integration',
        body: 'Each dependency update creates a note in your Kote with full analysis, breaking changes, and next steps.',
      },
      {
        title: 'Daily Monitoring',
        body: 'An automated cron job checks for new versions daily and processes updates in the background.',
      },
      {
        title: 'Project Dependencies Panel',
        body: 'View monitored dependencies per project in the Dependencies tab. Trigger manual checks and see update status.',
      },
      { title: 'Documentation', body: 'For detailed configuration and troubleshooting, check the Dependency Watcher documentation on GitHub.', tip: 'View Dependency Watcher documentation at https://github.com/pedroaugusto04/Knowledge-Base/blob/main/docs/DEPENDENCY_WATCHER.md' },
    ],
  },
  {
    id: 'cli',
