...
export class DefaultAnswerGenerationGateway extends AnswerGenerationGateway {
  ...
  async generatePullRequestComment(
    ...
    const systemPrompt = [
      ...
      '## Output Format',
      '',
      'If valuable insights exist, return:',
      '',
      '## PR Insights',
      '',
      '### Summary',
      '[1–2 sentence system-level summary of what this PR changes and why it matters]',
      '',
      '---',
      '',
      '### Key Insights',
      ...
      '- **Insight:** [concise explanation of the issue or observation]',
      ...
      '- Do not exceed necessary verbosity',
