...
export const httpErrorCatalog = {
  ...
  missing_webhook_signature: { statusCode: HttpStatus.UNAUTHORIZED, safeMessage: 'Invalid webhook signature.', logLevel: HttpErrorLogLevel.Warn },
  invalid_webhook_signature: { statusCode: HttpStatus.UNAUTHORIZED, safeMessage: 'Invalid webhook signature.', logLevel: HttpErrorLogLevel.Warn },
  unauthorized_webhook: { statusCode: HttpStatus.UNAUTHORIZED, safeMessage: 'Unauthorized webhook.', logLevel: HttpErrorLogLevel.Warn },
  ...
  attachment_not_found: { statusCode: HttpStatus.NOT_FOUND, safeMessage: 'Attachment not found.', logLevel: HttpErrorLogLevel.Info },
  review_not_found: { statusCode: HttpStatus.NOT_FOUND, safeMessage: 'Review not found.', logLevel: HttpErrorLogLevel.Info },
  dependency_not_found: { statusCode: HttpStatus.NOT_FOUND, safeMessage: 'Dependency not found.', logLevel: HttpErrorLogLevel.Info },
  folder_not_empty: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Folder is not empty.', logLevel: HttpErrorLogLevel.Warn },
  folder_cycle_not_allowed: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Folder cycle is not allowed.', logLevel: HttpErrorLogLevel.Warn },
  conversation_agent_unavailable: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Conversation agent is unavailable.', logLevel: HttpErrorLogLevel.Warn },
  job_not_found: { statusCode: HttpStatus.NOT_FOUND, safeMessage: 'Job not found.', logLevel: HttpErrorLogLevel.Info },
  job_already_finished: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Job is already finished.', logLevel: HttpErrorLogLevel.Warn },
  repositories_required: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Repositories are required.', logLevel: HttpErrorLogLevel.Warn },
  backfill_already_completed: { statusCode: HttpStatus.CONFLICT, safeMessage: 'Backfill is already completed.', logLevel: HttpErrorLogLevel.Warn },
  github_connection_required: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'GitHub connection is required.', logLevel: HttpErrorLogLevel.Warn },
  github_repository_not_selected: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'GitHub repository is not selected.', logLevel: HttpErrorLogLevel.Warn },
  invalid_dependency_repository_selection: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Invalid dependency repository selection.', logLevel: HttpErrorLogLevel.Warn },
  test_email_auth_not_configured: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Test email authentication is not configured.', logLevel: HttpErrorLogLevel.Error },
  invalid_test_email_auth: { statusCode: HttpStatus.UNAUTHORIZED, safeMessage: 'Invalid test email authentication.', logLevel: HttpErrorLogLevel.Warn },
  rabbitmq_not_configured: { statusCode: HttpStatus.INTERNAL_SERVER_ERROR, safeMessage: 'Message queue is not configured.', logLevel: HttpErrorLogLevel.Error },
  embedding_strategy_not_available: { statusCode: HttpStatus.INTERNAL_SERVER_ERROR, safeMessage: 'Embedding service is not available.', logLevel: HttpErrorLogLevel.Error },
  external_reference_missing: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'External reference is missing.', logLevel: HttpErrorLogLevel.Warn },
  external_reference_invalid: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'External reference is invalid.', logLevel: HttpErrorLogLevel.Warn },
