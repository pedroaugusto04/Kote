...
export const httpErrorCatalog = {
  ...
  project_brief_ai_not_configured: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Project Brief AI is not configured.', logLevel: 'warn' },
  project_brief_ai_not_connected: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Project Brief AI is not connected.', logLevel: 'warn' },
  project_brief_generation_failed: { statusCode: HttpStatus.SERVICE_UNAVAILABLE, safeMessage: 'Project brief generation failed.', logLevel: 'warn' },
