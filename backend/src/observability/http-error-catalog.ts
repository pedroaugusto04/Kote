...
export const httpErrorCatalog = {
  ...
  invalid_create_project_payload: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Payload de criacao de projeto invalido.', logLevel: 'warn' },
  invalid_create_note_payload: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Payload de criacao de nota invalido.', logLevel: 'warn' },
  ...
  github_callback_missing_installation: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Instalacao do GitHub ausente no callback.', logLevel: 'warn' },
  ...
  folder_not_found: { statusCode: HttpStatus.NOT_FOUND, safeMessage: 'Pasta nao encontrada.', logLevel: 'info' },
  folder_has_notes: { statusCode: HttpStatus.BAD_REQUEST, safeMessage: 'Exclua ou mova as notas da pasta antes de remover.', logLevel: 'info' },
